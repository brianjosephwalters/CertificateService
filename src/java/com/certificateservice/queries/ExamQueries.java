package com.certificateservice.queries;
...
public class ExamQueries {
	...
	public List<Exam> getAllExams() throws SQLException {
        ...
        public List<Exam> getExamsForCertificate(String certificateCode) 
            ...
            PreparedStatement stmt = connection.prepareStatement(
                    " SELECT * " +
                    " FROM exam NATURAL JOIN exam_type " +
        ...
        public List<Exam> getAllUpcomingExams(String certificateCode)
                throws SQLException {
            List<Exam> list = null;
            PreparedStatement stmt = connection.prepareStatement(
                " SELECT * " +
                " FROM exam NATURAL JOIN exam_type " +
                " WHERE certificate_code = ? AND " +
